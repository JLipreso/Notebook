---
name: refresh-docs
description: Use when routes, controllers, or env templates changed, or someone asks to "update the reference docs" / "regenerate the endpoints list" / notices the endpoint or env-var reference is stale. Regenerates the auto-generated references under document/0000-00-00-000-Memory/.
---
