...
| **"where's the artifact link", boss documents, the progress tracker** | [documents/claude-artifact-list.md](documents/claude-artifact-list.md) — the master list of every published artifact (blueprint, requirements, brand pitch, live M1 tracker). Revise artifacts to the SAME URL, never re-create |
...
| **M3, payments, entitlements, subscriptions, admin panel, GCash workflow** | [documents/2026-09-13-008-M3-Money-Admin-Plan/README.md](documents/2026-09-13-008-M3-Money-Admin-Plan/README.md) — milestone-level plan (Phase-301…311), all questions closed (D-037…D-041; purchase flow is WEB-ONLY per D-040). **Do NOT implement from it yet** — detail-fill after M2 Phase-204 |
