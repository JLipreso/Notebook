...
// All fields the brief requires at registration. Address is NOT collected here
// — Phase 005 keeps it in the profile screen so sign-up stays short.
...
<template>
  <main class="flex min-h-screen items-center justify-center bg-paper p-8">
    <div class="w-full max-w-lg rounded-lg border border-paper-shade bg-paper p-8 shadow-sm">
