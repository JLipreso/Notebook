...
| 4 — M2 TEACHER mobile (12 screens) | [claude-design-brief-4.md](claude-design-brief-4.md) | `Notebook-Teacher-Mobile-12-screens.html` (expected) | **ready to run** (D-033) |
| 5 — M2 TEACHER browser (12 screens) | [claude-design-brief-5.md](claude-design-brief-5.md) | `Notebook-Teacher-Browser-12-screens.html` (expected) | **ready to run** — after pass 4 |
