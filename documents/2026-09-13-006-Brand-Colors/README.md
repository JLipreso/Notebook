...
| 4 — M2 TEACHER mobile (12 screens) | [claude-design-brief-4.md](claude-design-brief-4.md) | [Notebook-Teacher-Mobile-12-screens.html](Notebook-Teacher-Mobile-12-screens.html) | **done** — [note](design-pass-4-complete.md) |
| 5 — M2 TEACHER browser (12 screens) | [claude-design-brief-5.md](claude-design-brief-5.md) | [Notebook-Teacher-Browser-12-screens.html](Notebook-Teacher-Browser-12-screens.html) | **done** — [note](design-pass-5-complete.md) |

**Typefaces (confirmed from the approved canvases, folded back 2026-09-13): display = Fraunces · UI/body = Figtree.** Set in the preset's `fontFamily` tokens and loaded via `@fontsource` imports in each app's `main.ts` — bundled with the build (offline-safe), never from a CDN. The M1 design thread is closed and **the M2 teacher design surface is COMPLETE (passes 4–5, D-033)** — teacher mobile + browser canonical references are in the pass table above. Tablet / admin passes stay parked (D-029; admin = M3 pre-work).
